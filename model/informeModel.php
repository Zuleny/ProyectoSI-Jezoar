...
class Informe{
    ...
    public function getListInforme(){
        return $result = $this->conexion->execute("select cod_informe, nombre, informe.fecha,imageafter, imagebefore,informe.cod_presentacion_cotizacion from cliente,informe, presentacion where cod_cliente=cod_cliente_presentacion and cod_presentacion=informe.cod_presentacion_cotizacion order by cod_informe;");
    }
