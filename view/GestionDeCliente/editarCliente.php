            ...
            <div class="box box-info">
                ...
                <form role="form" action="../../controller/clienteController.php" method="get" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group margin-bottom-sm">
                                ...
                                <input type="text" class="form-control" name ="nit_cliente"  value="<?php echo pg_result($resultado,0,5) ?>">
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-lg-3">
                            <button type="submit" name ="cod" value= "<?php echo pg_result($resultado,0,6)?>" class="btn btn-block btn-success" style="border-radius: 15px;" title="Agregar Servicio">Registrar cambios <i class="fa fa-fw fa-save"></i></button>
