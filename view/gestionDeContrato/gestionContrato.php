                            ...
                            <div class="row">
                                ...
                                <div class="container">                         
                                    <div class=" row bg-primary col-lg-2">
                                        <label for="codigo del informe" style="margin: 8px 7px 7px" >Codigo de contrato:</label >
                                    </div> 
                                    <div class="col-sm-2">
                                ...
                                <div class="row">
                                    <div class="container"  > 
                                        <div class=" row bg-success col-lg-2">
                                            <label for="codigo del informe" style="margin: 7px 7px 7px" >Fecha de inicio:</label>
                                        </div> 
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-md-2" id="text_codInforme">
                                        </div>
                                        <div class="container"> 
                                            <div class=" row bg-success col-lg-2"style="margin-left: 40px">
                                                <label for="codigo del informe"  style="margin: 7px 7px 7px" >Fecha final:</label>
                                            </div> 
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control input-md-2" id="text_codInforme" ">
                                            </div>
                                        ...
                                        <div class="row">
                                            <br><br>
                                            <div class="container">                         
                                            <div class=" row bg-primary col-xs-3">
                                                <label for="codigo del informe" style="margin: 7px 7px 7px" >Codigo de presentación: </label>
                                            </div> 
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control input-lg2"  id="text_codInforme" placeholder="Solo numérico" >
                                                <br><br>
                                            ...
                                            <div class="container" >                       
                                                <div class=" row bg-primary col-lg-2"style="margin-left: 40px">
                                                    <label for="nombre cliente" style="margin: 7px 7px 7px" >Nombre del cliente:</label >
                                                </div> 
                                                <div class="col-sm-4">
                                        ...
                                        <div class="row"> <br>                 
                                            <div class="container">                                                     
                                                <div class=" row col-lg-1" style="margin-right: 70px">
                                                    <button type="submit" class="btn btn-primary">Ver informe </button>
                                                </div>                                 
                                                <div class=" row col-lg-1">
                                                    <button type="submit" class="btn btn-primary">Ver presentacion </button>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
